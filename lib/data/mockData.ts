...
import { Building2, Newspaper, FileText, AlertTriangle } from "lucide-react";

// Quick Actions for Home Dashboard
export const quickActions: QuickAction[] = [
  { id: "1", title: "Agencies", icon: Building2, route: "/agencies" },
  { id: "2", title: "News", icon: Newspaper, route: "/news" },
  { id: "3", title: "Complaints", icon: FileText, route: "/account/my-complaints" },
  { id: "4", title: "Emergency", icon: AlertTriangle, route: "/emergency" },
];
    ...
    subServices: [
      {
        ...
        description: "Financial aid for medical expenses",
      },
      {
        id: "s2",
        title: "Supplemental Feeding Program",
        description: "Nutrition support for children",
      },
      {
        id: "s3",
        title: "Immunization Services",
        description: "Free vaccines for children and adults",
      },
    ],
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: "Programs for elderly citizens",
      },
    ],
  },
  {
    ...
    subServices: [
      {
        id: "s7",
        title: "Socialized Housing Program",
        description: "Affordable housing for qualified residents",
      },
      {
        id: "s8",
        title: "Urban Poor Registration",
        description: "Register for housing benefits",
      },
    ],
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: "Athletic training and facilities",
      },
      {
        id: "s11",
        title: "Cultural Events",
        description: "Festivals and cultural activities",
      },
    ],
  },
  {
    ...
    subServices: [
      {
        ...
        description: "Access to government documents",
      },
      {
        id: "s18",
        title: "Citizens Complaints",
  ...
  },
  {
    ...
    subServices: [
      ...
      },
      {
        ...
        description: "Sound system and facility booking",
      },
    ],
  },
];
...
export const newsArticles: NewsArticle[] = [
  {
    id: "n1",
    title:
      "Naga's IMT, EOC conduct post-assessment of Super Typhoon Uwan response",
    category: "COMMUNITY",
    excerpt:
      "The Incident Management Team (IMT) and Emergency Operations Center (EOC) of Naga City conducted a comprehensive review of their response to Super Typhoon Uwan.",
  ...
  },
  {
    id: "n2",
    title:
      "Mayor Robredo cites 'minimal damage' post Uwan, aims urgent retrofitting of evacuation centers",
    category: "Community",
    excerpt:
      "Mayor announces plans to strengthen evacuation facilities following successful disaster response.",
    publishedAt: "2025-11-13",
    featured: false,
  },
  {
    ...
    category: "Technology",
    excerpt:
      "Citizens can now access more government services online through the new e-government portal.",
  ...
  },
  {
    ...
    category: "Livelihood",
    excerpt:
      "The city government announces various livelihood training programs for residents.",
